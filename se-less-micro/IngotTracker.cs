...
namespace IngameScript
{
    ...
    {
        public class IngotTracker: IRunnableModule
        {
            public const string CONFIG_GROUP = "IngotTracker";
            ...
            public IngotTracker(MyIni config, IMyGridTerminalSystem grid, ErrorReporter reporter)
            {
                this.grid = grid;
            ...
            {
                return Util.HandleBasicBlockReport(display, "Ingot Display", true, Name);
            }
